 ...
 *
 *=========================================================================*/
#ifndef itkInvertDisplacementFieldImageFilterOkan_h
#define itkInvertDisplacementFieldImageFilterOkan_h
...
/**
 * \class InvertDisplacementFieldImageFilterOkan
 *
...
class ITK_TEMPLATE_EXPORT InvertDisplacementFieldImageFilterOkan : public ImageToImageFilter<TInputImage, TOutputImage>
{
public:
  ITK_DISALLOW_COPY_AND_MOVE(InvertDisplacementFieldImageFilterOkan);

  using Self = InvertDisplacementFieldImageFilterOkan;
  ...
  itkTypeMacro(InvertDisplacementFieldImageFilterOkan, ImageToImageFilter);
...
protected:
  /** Constructor */
  InvertDisplacementFieldImageFilterOkan();

  /** Deconstructor */
  ~InvertDisplacementFieldImageFilterOkan() override = default;
...
#  include "itkInvertDisplacementFieldImageFilterOkan.hxx"
#endif
