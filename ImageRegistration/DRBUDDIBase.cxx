...
/*
 Resample blip-up blip-down images so that they have the same image size and resolution as structural images
 blip-up blip-down images might have different image resolution from the structual image
*/
...
/*
  Juan comments lots of codes here to disable tensor fitting
*/
void DRBUDDIBase::CreateCorrectionImage(std::string nii_filename,ImageType3D::Pointer &b0_img, ImageType3D::Pointer &FA_img)
{
    ...
    //  }
     ...
     else
     {
         ...
         float b0bval = 0; //bvals.min_value();
