...
#define WIN_RADCC 4      //inplane correlation window size 
#define WIN_RADCC_Z 3    //slice correlation window size 
#define LIMCC (1E-10)

/*
Calculate the deformation field updates based on CC

Inputs: index - voxel index
        up_img, down_img - blip-up blip-down images
        updateF, updataM - calculated updated change in deformation fields for this voxel position
*/
                          ...
                          DisplacementFieldType::PixelType &updateF,DisplacementFieldType::PixelType &updateM)                          
{
    ...
    // get the neighborhood start/end of index for correlation calculation
...
/*
    Caculate metric CC and updateFieldF/M
    Inputs: up_img 
            down_img
    Outputs:
            CC value
                       ...
                       DisplacementFieldType::Pointer &updateFieldF, DisplacementFieldType::Pointer &updateFieldM)
{
    ...
    // per pixel, calculate the correlation value, updateFieldF, updateFieldM
